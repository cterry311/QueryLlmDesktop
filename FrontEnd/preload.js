...
contextBridge.exposeInMainWorld('llm', {
    send: (message, model, routeId, newConversation) => ipcRenderer.invoke('llm:send', message, model, routeId, !!newConversation),
    stream: (message, model, routeId, newConversation) => ipcRenderer.invoke('llm:stream', message, model, routeId, !!newConversation),
